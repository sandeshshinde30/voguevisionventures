          ...
          <table className="mt-8 lg:w-3/5 w-[85%] bg-white shadow-xl tracking-wider">
            ...
            <tbody className="text-sm">
              ...
              <tr className="bg-green-50">
                ...
                <td className="p-2 font-semibold border border-gray-300 px-4 text-red-900 py-3">
                  {totalMRP}
                </td>
                <td className="p-2 border border-gray-300 text-dark-green font-extrabold px-4 py-3">
                  {totalOfferPrice}
                </td>
              </tr>
            </tbody>
